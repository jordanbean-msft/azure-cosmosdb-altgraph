$(document).ready(function () {
  ...
  const nodesCsv = csvToArr(
    dataElement.dataset.nodesCsv == "" ? null : dataElement.dataset.nodesCsv
  );
  nodesCsv?.map(function (n) {
    console.log(n);
    nodes.push(n);
  });
  const edgesCsv = csvToArr(
    dataElement.dataset.edgesCsv == "" ? null : dataElement.dataset.edgesCsv
  );
